    ...
    <nav class="navbar">
      <div class="nav-content">
        <div class="logo">
          ...
          <span classkaos="logo-text">贷后催收培训</span>
        </div>
        <div class="nav-links">
    ...
    <main class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-content">
          <h1 class="hero-title">
            贷后催收培训
            <span class="hero-highlight">助手</span>
          </h1>
        ...
        <div class="features-grid">
          ...
          >
            <div class="card-content">
              ...
              <h3 class="card-title">催收问答小助手</h3>
              <p class="card-description">
