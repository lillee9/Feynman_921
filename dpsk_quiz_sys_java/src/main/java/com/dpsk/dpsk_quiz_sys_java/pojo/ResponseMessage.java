package com.dpsk.dpsk_quiz_sys_java.pojo;
...
public class ResponseMessage<T>{
    ...
    public static <T> ResponseMessage<T> error(T data){
        return new ResponseMessage<T>(HttpStatus.EXPECTATION_FAILED.value(), "error",data);
    }

    public static <T> ResponseMessage<T> error(){
        return new ResponseMessage<T>(HttpStatus.EXPECTATION_FAILED.value(), "error",null);
    }
