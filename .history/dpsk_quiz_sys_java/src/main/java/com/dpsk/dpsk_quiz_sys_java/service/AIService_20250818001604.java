...
public class AIService implements IAIService {
    ...
    private static final String AI_API_KEY = "sk-your-api-key-here"; // 需要配置实际的API密钥
    
    @Override
    public Map<String, Object> generateQuestionFromChunk(String chunkContent, ExamQuestion.QuestionType questionType, String difficulty) {
        try {
    ...
    public List<Map<String, Object>> generateQuestionsFromPrompt(String prompt, Integer questionCount, String difficulty) {
        ...
        try {
            ...
            while (questions.size() < questionCount) {
                questions.add(createFallbackQuestion(prompt, ExamQuestion.QuestionType.single));
            }
            ...
            for (int i = 0; i < questionCount; i++) {
                allQuestions.add(createFallbackQuestion(prompt, ExamQuestion.QuestionType.single));
            }
        }
    ...
    public Map<String, Object> generateSingleChoiceQuestion(String content, String difficulty) {
        return generateQuestionFromChunk(content, ExamQuestion.QuestionType.single, difficulty);
    }
    
    @Override
    public Map<String, Object> generateMultiChoiceQuestion(String content, String difficulty) {
        return generateQuestionFromChunk(content, ExamQuestion.QuestionType.multi, difficulty);
    }
    
    @Override
    public Map<String, Object> generateJudgeQuestion(String content, String difficulty) {
        return generateQuestionFromChunk(content, ExamQuestion.QuestionType.judge, difficulty);
    }
    ...
    @Override
    public String extractCorrectAnswer(Map<String, Object> questionData, ExamQuestion.QuestionType questionType) {
        Object answer = questionData.get("correctAnswer");
        if (answer == null) {
            return questionType == ExamQuestion.QuestionType.judge ? "A" : "A";
        }
    ...
    private Map<String, Object> createFallbackQuestion(String content, ExamQuestion.QuestionType questionType) {
        Map<String, Object> question = new HashMap<>();
