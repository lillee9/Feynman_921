...
public class ExamQuestionResponse {
    ...
    private ExamQuestion.QuestionType questionType;
    ...
    public ExamQuestion.QuestionType getQuestionType() {
        return questionType;
    }
    
    public void setQuestionType(ExamQuestion.QuestionType questionType) {
