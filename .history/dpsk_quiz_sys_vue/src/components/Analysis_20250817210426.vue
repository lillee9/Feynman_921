                    ...
                    <div class="stats-grid">
                      ...
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.singleTypeName || "单选题" }}准确率
                        </div>
                        <div class="stat-value">
                      ...
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.multiTypeName || "多选题" }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.multiAccuracy || "0/0" }}
                        </div>
                      </div>
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.judgeTypeName || "判断题" }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.judgeAccuracy || "0/0" }}
                        </div>
                      </div>
                    </div>
                  </div>
