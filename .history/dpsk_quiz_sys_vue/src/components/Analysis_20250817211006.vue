...
const fetchScoreData = () => {
  axios
    ...
    .then((response) => {
      ...
      currentPaper.value = {
        ...currentPaper.value,
        singleTypeName: response.data.singleTypeName,
        singleAccuracy: response.data.singleAccuracy,
        multiTypeName: response.data.multiTypeName,
        multiAccuracy: response.data.multiAccuracy,
        judgeTypeName: response.data.judgeTypeName,
        judgeAccuracy: response.data.judgeAccuracy,
      };
    })
    .catch((error) => {
