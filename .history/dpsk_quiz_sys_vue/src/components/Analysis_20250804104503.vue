    ...
    if (event.data === "end") {
      ...
      try {
        ...
        if (result.weakPoints) {
          analysisResult.value.weakPoints += Array.isArray(result.weakPoints)
            ? result.weakPoints.join("")
            : result.weakPoints;
        }
        if (result.suggestions) {
          analysisResult.value.suggestions += Array.isArray(result.suggestions)
