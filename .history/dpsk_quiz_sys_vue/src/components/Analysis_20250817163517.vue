                ...
                <div class="score-time-section">
                  <div class="score-time-card">
                    ...
                    <div class="circle-stats">
                      <div
                        v-for="(item, index) in questionStats"
                        :key="index"
                        class="circle-item"
                      >
                        <div class="circle-title">{{ item.label }}</div>
                        <div class="circle-chart" ref="chartRefs"></div>
                      </div>
                    </div>
                  </div>
                </div>
...
const questionStats = ref([
  { label: "单选", correct: 11, total: 12 },
  { label: "多选", correct: 8, total: 10 },
  { label: "判断", correct: 5, total: 8 },
]);

const initCharts = () => {
  nextTick(() => {
    chartRefs.value.forEach((chartDom, index) => {
      const item = questionStats.value[index];
        ...
        series: [
          {
            ...
            label: { show: false },
            data: [
              { value: item.correct, itemStyle: { color: "#91CC75" } },
              {
                value: item.total - item.correct,
