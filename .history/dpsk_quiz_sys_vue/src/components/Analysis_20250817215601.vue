                    ...
                    <div class="stats-grid">
                      ...
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.questionType1 || "题型一" }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.accuracy1 || "0/0" }}
                        </div>
                      </div>
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.questionType2 || "题型二" }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.accuracy2 || "0/0" }}
                        </div>
                      </div>
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.questionType3 || "题型三" }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.accuracy3 || "0/0" }}
                        </div>
                      </div>
                    </div>
                  </div>
