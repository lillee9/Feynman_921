  ...
  setup() {
    ...
    const loadDocuments = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `/api/kb/documents?page=${currentPage.value - 1}&size=${
            pageSize.value
          }`,
          {
            method: "GET",
        ...
        if (response.ok) {
          ...
          documents.value = data.data.content || [];
    ...
    const loadChunkCount = async (document) => {
      try {
        const token = getCookie("token");
        const response = await fetch(
          `/api/kb/chunks/count?documentId=${document.documentId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const processDocument = async (documentId) => {
      try {
        const token = getCookie("token");
        const response = await fetch(
          `/api/kb/documents/${documentId}/process`,
          {
            method: "POST",
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const deleteDocument = async (document) => {
      try {
        ...
        const token = getCookie("token");
        const response = await fetch(
          `/api/kb/documents/${document.documentId}`,
          {
            method: "DELETE",
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const loadChunks = async (documentId) => {
      ...
      try {
        const token = getCookie("token");
        const response = await fetch(`/api/kb/chunks/document/${documentId}`, {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
