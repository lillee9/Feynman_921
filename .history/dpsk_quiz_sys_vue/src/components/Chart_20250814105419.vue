...
const fetchChartData = async () => {
  try {
    ...
    // 更新信息图表
    // if (chartData.value) {
    //   infoChart.totalUsers = chartData.value.totalUsers;
    //   infoChart.updateTime = chartData.value.updateTime;
    //   infoChart.yesterdayUsers = chartData.value.yesterdayUsers;
    // }
    console.log("获取数据成功11112211:", infoChart.value.totalUsers);
    // 更新图表
