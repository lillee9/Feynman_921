                    ...
                    <div class="circle-stats">
                      <div class="circle-container">
                        <div class="progress-circle">
                          ...
                          <div class="circle-text">
                            <div class="circle-value">11/12</div>
                            <div class="circle-subtext">正确率 91.7%</div>
                          </div>
                        </div>
                        <div class="circle-title">单选题</div>
                      </div>
                      ...
                      <div class="circle-container">
                        <div class="progress-circle">
                          ...
                          <div class="circle-text">
                            <div class="circle-value">8/10</div>
                            <div class="circle-subtext">正确率 80.0%</div>
                          </div>
                        </div>
                        <div class="circle-title">多选题</div>
                      </div>
                      ...
                      <div class="circle-container">
                        <div class="progress-circle">
                          ...
                          <div class="circle-text">
                            <div class="circle-value">5/5</div>
                            <div class="circle-subtext">正确率 100%</div>
                          </div>
                        </div>
                        <div class="circle-title">判断题</div>
                      </div>
                    </div>
                  </div>
                </div>
