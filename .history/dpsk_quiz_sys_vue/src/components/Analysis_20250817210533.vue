                    ...
                    <div class="stats-grid">
                      ...
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.singleTypeName }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.singleAccuracy || "0/0" }}
                        </div>
                      </div>
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.multiTypeName }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.multiAccuracy }}
                        </div>
                      </div>
                      <div class="stat-item small-stat">
                        <div class="stat-label">
                          {{ currentPaper.judgeTypeName }}准确率
                        </div>
                        <div class="stat-value">
                          {{ currentPaper.judgeAccuracy }}
                        </div>
                      </div>
                    </div>
                  </div>
