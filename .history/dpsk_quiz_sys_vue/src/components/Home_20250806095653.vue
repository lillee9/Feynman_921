    ...
    <main class="main-content">
      ...
      <section class="features-section">
        ...
        <div class="features-grid">
          <div class="feature-card large-card clickable" @click="goToGenerator">
          ...
          <div class="feature-card medium-card">
            <div class="card-content">
          ...
          <div class="feature-card medium-card clickable" @click="goToAnalysis">
            <div class="card-content">
              <div class="card-icon camera-icon">
                <el-icon><PictureFilled /></el-icon>
              </div>
          ...
          <div class="feature-card medium-card clickable" @click="goToChat">
            <div class="card-content">
          ...
          <div class="feature-card small-card clickable" @click="goToQuiz">
            <div class="card-content">
          ...
          <div class="feature-card small-card clickable" @click="goToChart">
            <!-- 新增clickable类和点击事件 -->
            <div class="card-content">
              <div class="card-icon quiz-icon">
...
const goToChart = () => {
  // 新增跳转方法
  router.push("/chart"); // 跳转到Chart.vue对应的路由
};
const goToQuiz = () => {
  router.push("/quiz");
};
