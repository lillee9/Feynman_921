      ...
      <section class="rankings-section">
        <div class="ranking-card" v-loading="loading">
          <div class="section-header">
            ...
            <h2 class="section-title">历史试卷记录</h2>
            <p class="section-desc">您完成的所有考试记录</p>
          </div>

          <div class="paper-list">
            <div class="paper-item" v-for="paper in papers" :key="paper.paper_id">
              <div class="paper-info">
                <div class="paper-name">{{ paper.paper_name }}</div>
                <div class="paper-meta">
                  <span class="difficulty">难度：{{ ['简单', '中等', '困难'][paper.paper_difficulty - 1] }}</span>
                  <span class="score">得分：{{ paper.total_score }}分</span>
                  <span class="time">完成时间：{{ formatTime(paper.end_time) }}</span>
                </div>
              </div>
            </div>
            <div v-if="papers.length === 0" class="empty-tip">
