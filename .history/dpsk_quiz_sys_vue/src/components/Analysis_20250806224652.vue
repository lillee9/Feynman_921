      ...
      <section class="rankings-section">
        <div class="rankings-grid">
          <div class="ranking-card">
            ...
            <el-dialog
              :title="currentPaper.paperName"
              :visible.sync="showPaperInfoDialog"
              width="50%"
            >
...
export default {
  data() {
    return {
      // ... existing code ...
      showPaperInfoDialog: false, // 控制模态框显示
      currentPaper: {}, // 当前选中的试卷数据
    };
  },
  methods: {
    // ... existing code ...
    ...
    showPaperDetails(paper) {
      this.currentPaper = paper; // 保存当前试卷数据
      this.showPaperInfoDialog = true; // 显示模态框
    },
  },
};
// 分析状态和结果
