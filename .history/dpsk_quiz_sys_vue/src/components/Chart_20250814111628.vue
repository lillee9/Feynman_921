      ...
      <div class="upper-section">
        ...
        <div class="info-section">
          <div class="update-info">
            <span>数据更新时间：{{ infoUpdateTimeChart.updateTime }}</span>
            <span>总参与人数：{{ infoTotalUsersChart.totalUsers }}</span>
            <span>昨日答题人数：{{ infoChart.yesterdayUsers }}</span>
          </div>
        </div>
...
const infoTotalUserChart = ref(null);
const infoUpateTimeChart = ref(null);
const infoYesterdayUserChart = ref(null);
// 初始化饼图
...
const fetchChartData = async () => {
  try {
    ...
    infoUpateTimeChart.value = chartData.value.updateTime;
    infoYesterdayUserChart.value = chartData.value.yesterdayUsers;
    console.log("获取数据成功11112211:", infoTotalUserChart.value);
    console.log("获取数据成功11112211:", infoUpateTimeChart.value);
    console.log("获取数据成功11112211:", infoYesterdayUserChart.value);
    console.log("获取数据成功11112211:", infoChart.value);
    // 更新图表
