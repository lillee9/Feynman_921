...
const analyzeAnswers = async () => {
  ...
  analysisResult.value = {
    weakPoints: processData(recordData.analysis_data),
    suggestions: processData(recordData.advice_data)
  };
} catch (error) {
  console.error('JSON解析错误:', {
    error,
    rawData: recordData.analysis_data,
    processed: recordData.analysis_data
      .replace(/^"|"$/g, '')
      .replace(/&quot;/g, '"')
  });
  // ... 原有错误处理 ...
