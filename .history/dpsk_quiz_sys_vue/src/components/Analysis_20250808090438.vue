                    ...
                    <div v-if="analysisResult" class="analysis-results">
                      ...
                      >
                        ...
                        <pre
                          ...
                          >{{
                            JSON.stringify(analysisResult.weakPoints, null, 2)
                          }}</pre
                        >
                      </div>
                      ...
                      >
                        ...
                        <pre
                          ...
                          style="white-space: pre-wrap"
                          >{{
                            JSON.stringify(analysisResult.suggestions, null, 2)
                          }}</pre
                        >
                      </div>
    ...
    if (checkData.canAnalyze) {
      ...
      try {
        ...
        analysisResult.value = {
          weakPoints: parseData(recordData.analysis_data),
          suggestions: parseData(recordData.advice_data)
        };
        } catch (error) {
          console.error('JSON解析失败:', {
            error,
            rawData: {
              analysis: recordData.analysis_data,
              advice: recordData.advice_data
            }
          });
          analysisResult.value = {
            weakPoints: '解析失败: ' + error.message,
            suggestions: '请联系管理员检查数据格式'
          };
        }
      } catch (error) {
