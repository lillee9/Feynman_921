<template>
  <div class="analysis-container">
    ...
    <main class="main-content">
      ...
      <section class="rankings-section">
        <div class="ranking-card">
          <h3 class="section-title">历史试卷记录</h3>

          <div v-if="!loading" class="paper-list">
            <div
              v-for="paper in papers"
              :key="paper.paperId"
              class="paper-item hover-effect"
            >
              <div class="paper-header">
                <span class="paper-name">{{ paper.paperName }}</span>
                <el-tag
                  :type="difficultyTypes[paper.paperDifficulty]?.type"
                  size="small"
                  effect="dark"
                >
                  {{ difficultyTypes[paper.paperDifficulty]?.label }}
                </el-tag>
              </div>
              ...
              <div class="paper-stats">
                ...
                <div class="stat-item">
                  ...
                  <span>{{ formatTime(paper.endTime) }}</span>
                </div>
              </div>
            </div>
