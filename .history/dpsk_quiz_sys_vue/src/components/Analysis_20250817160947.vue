                  ...
                  <div class="score-time-card">
                    ...
                    <div class="stats-grid">
                      ...
                      <div class="chart-container">
                        <div class="chart-title">单选题</div>
                        <div ref="singleChoiceChart" class="chart-item"></div>
                      </div>
                      <div class="chart-container">
                        <div class="chart-title">多选题</div>
                        <div ref="multipleChoiceChart" class="chart-item"></div>
                      </div>
                      <div class="chart-container">
                        <div class="chart-title">判断题</div>
                        <div ref="judgmentChart" class="chart-item"></div>
                      </div>
                    </div>
                  </div>
                </div>
